...
if [ -f "${CACHE_FILE}" ]; then
  ...
  if (tput colors 2>/dev/null >/dev/null) && [ "$NO_ARRAYS" != "1" ]; then
    ...
    export COLOR_PURPLE_BOLD="$_bold$COLOR_PURPLE"
    export COLOR_ORANGE_BOLD="$_bold$COLOR_ORANGE"
...
export COLOR_PURPLE_BOLD="${COLOR_PURPLE_BOLD}"
export COLOR_ORANGE_BOLD="${COLOR_ORANGE_BOLD}"
